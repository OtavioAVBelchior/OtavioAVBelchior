...
- Combinação estratégica de tecnologias modernas (TypeScript, Node.js, React, Python) com profundo conhecimento em sistemas legados corporativos  
- Experiência comprovada na entrega de projetos complexos com gestão de equipe e comunicação clara com C-Level  
- Foco constante em eficiência operacional, automação e geração de valor mensurável para o negócio
