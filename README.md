...
Atualmente atuo conectando estratégia de negócio e execução tecnológica, transformando demandas da diretoria em soluções escaláveis, com foco em produtividade, eficiência operacional e geração de valor.

Especialista na integração entre tecnologias modernas e sistemas corporativos legados, com forte atuação em TOTVS Protheus, ADVPL, infraestrutura e transformação digital.
...
- Continuidade operacional e suporte ao negócio
...
- Integrações com RD Station, ClickUp e APIs externas
- Eliminação de atividades manuais através de automação

### Liderança Técnica

- Coordenação de equipe e demandas
- Priorização de backlog
- Alinhamento com diretoria e stakeholders
- Planejamento de projetos e iniciativas de transformação digital

## Diferenciais

- Visão estratégica de negócio aliada à execução técnica
- Experiência em infraestrutura e desenvolvimento
- Forte atuação em automação e eficiência operacional
- Integração entre sistemas modernos e legados
- Conhecimento sólido em TOTVS Protheus e ADVPL
- Comunicação direta com liderança executiva
...
[![GitHub](https://img.shields.io/badge/GitHub-OtavioVBelchior-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/OtavioVBelchior)

---

🐧 Linux Enthusiast • 🚀 Open to New Opportunities
